  ...
  public: {
    Tables: {
      ...
      participant_ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "participant_ratings_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "participant_ratings_rated_user_id_fkey"
          ...
          {
            foreignKeyName: "participant_ratings_rater_user_id_fkey"
      ...
      plan_attendance: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "plan_attendance_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      plan_feedback: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "plan_feedback_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
